...
<head>
	...
	<title>Admin - Categoria - Publiq Mais</title>
					...
					<div class="content">
						...
						<div class="module">
							...
							<div class="module-body">
									...
									<form action="categoriacontroller.do" method="post" class="form-horizontal row-fluid">
										<div class="control-group">
											<label class="control-label" for="basicinput"></label>
											<div class="controls">
												<input type="hidden" id="basicinput" name="id" placeholder="Id" class="span8" value="${categoria.id}">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Título</label>
											<div class="controls">
												<input type="text" id="basicinput" name="titulo" placeholder="Type something here..." class="span8" value="${categoria.titulo}">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Descrição</label>
											<div class="controls">
												<textarea name="descricao" class="span8" rows="5"> ${categoria.descricao}</textarea>
											</div>
										</div>
