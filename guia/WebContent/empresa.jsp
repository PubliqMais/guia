...
<meta charset="utf-8" />
<title>Publiq Mais - Empresa</title>
...
<link rel="stylesheet" href="resources/css/prettyPhoto.css" type="text/css" media="screen" charset="utf-8" />
<!--[if (IE 6)|(IE 7)]>
...
<script type="text/javascript" src="resources/js/jquery.prettyPhoto.js" charset="utf-8"></script>
                    ...
                    <div class="container">
                        ...
                        <div class="twelve columns">
                            <div class="sidebar-right"> <!-- important if sidebar is on the right -->
                                ...
                                <br /><br />
                                <h5 class="title">${empresa.nomeFantazia}</h5>
                                
                               
                                <blockquote class="full"><a target="_blank" href="http://${empresa.site}">${empresa.site}</a></blockquote>
                                
                                <h5 class="title">Contatos e Localização</h5>

								<h3></h3>
								<h5 style="text-align:center">${empresa.logradouro}, ${empresa.numero} - ${empresa.complemento}</h5>
								<h5 style="text-align:center">${empresa.bairro} - ${empresa.cidade} / ${empresa.estado}</h5>
								<hr />
								<h1 style="text-align:center">${empresa.telefone}</h1>
